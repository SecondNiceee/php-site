                        ...
                        <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                                    ...
                                    <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="center" style="font-size: 25px; font-family: Helvetica, Arial, sans-serif; color: #333333; padding-top: 30px;" class="padding-copy">Новая заявка на звонок</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                                ...
                                <td>
                                    <table style="border: 1px solid #ddd; border-collapse: collapse; width: 100%;">
                                        ...
                                        <tr style="background: #f9f9f9;">
                                            ...
                                            <?php if(!empty($_POST['message'])) :?><th style="padding: 8px; border: 1px solid #ddd; text-align: left;">Сообщение: </th><?php endif;?>
                                        </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td style="padding: 8px; border: 1px solid #ddd;"><?=$_POST['name']?></td>
                                                <td style="padding: 8px; border: 1px solid #ddd;"><?=$_POST['phone']?></td>
                                                <?php if(!empty($_POST['message'])) :?><td style="padding: 8px; border: 1px solid #ddd;"><?=$_POST['message'] ?></td><?php endif;?>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
