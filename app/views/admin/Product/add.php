                        ...
                        <div class="row">
                           <form method="post" action="">
                              ...
                              <div class="mb-3">
                                 ...
                                 <input class="form-control" id="exampleFormControlInput1" name='title' type="text" placeholder="Наименование товара" value="<?=get_field_value('title')?>" >
                              </div>
                              <div class="mb-3">
                                 <label for="exampleFormControlTextarea1">Описание</label>
                                 <textarea class="form-control editor" name="content" id="exampleFormControlTextarea1" rows="3"><?=get_field_value('content')?></textarea>
                              </div>
                              <div class="card mb-4">
                                 ...
                                 <div class="card-body add" id="card-body">
                                    ...
                                    <?php if(isset($_SESSION['form_data']['product_info'])) :?>
                                       <?php $coin = 0; ?>
                                    <?php foreach($_SESSION['form_data']['product_info'] as $val) :?>
                                       
                                    <div class="row gx-3 mb-3" id="input<?=$coin?>">
                                       <div class="col-md-5">
                                          <label class="small mb-1" for="inputFirstName">Параметр</label>
                                          <input class="form-control" name="product_info[<?=$coin?>][key]" id="inputFirstName" type="text" value="<?=h($val['key']);?>" placeholder="Укажите параметр" >
                                       </div>      
                                       <div class="col-md-5">
                                          <label class="small mb-1" for="inputLastName">Значение</label>
                                          <input class="form-control" name="product_info[<?=$coin?>][value]" id="inputLastName" value="<?=h($val['value']);?>" type="text" placeholder="Укажите значение" >
                                       </div>
                              ...
                              <div class="card mb-3">
                                 ...
                                 <div class="card-body ">
                                    <!-- Profile picture image-->
                                    <div id="base-brosh-output" class="upload-images base-image mb-2"></div>
                              ...
                              <div class="card mb-3">
                                 ...
                                 <div class="card-body ">
                                    <!-- Profile picture image-->
                                    <div id="base-teh-output" class="upload-images base-image mb-2"></div>
                              ...
                              <div class="card mb-4">
                                 ...
                                 <div class="card-body">
                                    <div class="mb-3">
                                       ...
                                       <input class="form-control" id="exampleFormControlInput3" name='keywords' type="text" placeholder="Ключевые слова товара" value="<?=get_field_value('keywords')?>">
                                    </div>
                                    <div class="mb-3">
                                       <label for="exampleFormControlInput3">Мета описание</label>
                                       <input class="form-control" id="exampleFormControlInput3" name='description' type="text" placeholder="мета описание товара" value="<?=get_field_value('description')?>">
                                    </div>
                                 </div>
                              </div>
