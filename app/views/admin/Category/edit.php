                        ...
                        <div class="row">
                           <form method="post" action="">
                              ...
                              <div class="mb-3">
                                 ...
                                 <input class="form-control" id="exampleFormControlInput4" name='price' type="text" placeholder="Прайс" value="<?=h($category['price'])?>">
                              </div>
                              <div class="card mb-3">
                                    ...
                                    <div id="base-img-output" class="upload-images base-image mb-2">
                                       <?php if($category['img']) : ?>
                                          <div class="product-img-upload">
                                             <img style="max-width: 400px;" src="<?=$category['img']?>">
                              ...
                              <div class="card mb-3 base-icon-hide">
                                 ...
                                 <div class="card-body ">
                                    <!-- Profile picture image-->
                                    <div id="base-icon-output" class="upload-images base-image mb-2">
                                       <?php if($category['icon']) : ?>
                                          <div class="product-img-upload">
                                             <img style="max-width: 400px;" src="<?=$category['icon']?>">
                              ...
                              <div class="form-check">
                                 <input class="form-check-input" name="status" id="flexCheckChecked" type="checkbox" <?php if($category['status'] == 1) echo('checked'); ?>>
                                 <label class="form-check-label mb-3" for="flexCheckChecked">Показывать на сайте</label>
                              </div>
                              <div class="form-check">
                                 <input class="form-check-input" name="popular" id="flexCheckPopular" type="checkbox" <?php if($category['popular'] == 1) echo('checked'); ?>>
